//Add the following properties to the dog object: name, legs, tail, and likes. The name property should have a value that is a string, the legs property should have a value that is a number, the tail property should have a boolean value, and the likes property should have a value that is an array. Inside the array, include at least 4 values.
...
//Write a function that uses dot AND bracket notation to access and return the value of the fourth item in the likes array ("pets"). 
